package com.demo.springswagger.swagger;
...
public class Swagger2Config {
	...
	private ApiInfo apiEndPointInfo() {
		return new ApiInfoBuilder()
				.title("Spring Boot with Swagger Demo")
				.description("Employee Crud operations")
				.contact(new Contact("S Anilkumar", "http://localhost:8080", "sandrapati.anilkumar@gmail.com"))
				.license("Apache 2.0")
